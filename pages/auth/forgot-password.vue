<template>
  <div>
    <NuxtLink to="/auth/login" class="inline-flex items-center gap-1.5 text-xs text-white/40 hover:text-white/70 transition-colors mb-8">
    ...
    <div v-if="sent" class="text-center py-4">
      ...
      <p class="mt-3 text-sm text-white/50 leading-relaxed max-w-xs mx-auto">
    ...
    <div v-else>
      <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-white/50">Enter your email and we'll send a reset link instantly.</p>
      </div>
