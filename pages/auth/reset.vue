<template>
  <div>
    ...
    <div v-if="done" class="text-center py-4">
      ...
      <p class="mt-3 text-sm text-white/75">Your password has been reset. You can now sign in with your new password.</p>
    ...
    <div v-else-if="!token" class="text-center py-4">
      ...
      <p class="mt-3 text-sm text-white/75">This link is expired or invalid. Request a new one.</p>
    ...
    <div v-else>
      <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-white/75">Choose a strong password to secure your account.</p>
      </div>
      ...
      <form class="space-y-5" @submit.prevent="submit">
        <div>
          ...
          <div class="relative">
            ...
            />
            <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 text-white/55 hover:text-white/80 transition-colors" @click="showPassword = !showPassword">
