...
const plans = [
  {
    ...
    features: [
      '1 connected store',
      'Meta Ads + Shopify / WooCommerce sync',
      'Full 8-factor product scoring',
  ...
  {
    name: 'Growth',
    desc: 'For scaling brands running multiple stores and needing more data visibility.',
    monthlyPrice: 100,
    annualPrice: 80,
    cta: 'Get started',
    featured: true,
  ...
  {
    name: 'Scale',
    desc: 'Unlimited stores, advanced analytics, and the full MetaFlow intelligence platform.',
    monthlyPrice: 250,
    annualPrice: 200,
    cta: 'Get started',
    featured: false,
    ...
    features: [
      ...
      'Advanced Analytics (Products + Meta)',
      'Deep meta performance insights',
      'Catalog-level trend analysis',
...
const comparisonRows = [
  { feature: 'Connected stores',             starter: '1',            growth: 'Up to 5',        scale: 'Unlimited' },
  { feature: 'Channel integrations',         starter: true,           growth: true,             scale: true },
  { feature: 'Full 8-factor scoring',        starter: true,           growth: true,             scale: true },
  { feature: 'Automation rules',             starter: 'Unlimited',    growth: 'Unlimited',      scale: 'Unlimited' },
  { feature: 'AI morning briefing',          starter: true,           growth: true,             scale: true },
  { feature: 'Advanced Analytics',           starter: false,          growth: false,            scale: true },
  { feature: 'Multi-store dashboard',        starter: false,          growth: true,             scale: true },
  { feature: 'Audit log',                    starter: true,           growth: 'Unlimited',      scale: 'Unlimited' },
