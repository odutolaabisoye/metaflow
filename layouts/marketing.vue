                ...
                <div class="glass rounded-2xl p-2 shadow-card border border-white/15">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p class="text-xs text-white/50 mt-0.5">Cross-channel reporting</p>
                    </div>
                  </NuxtLink>
                  <NuxtLink
                    to="/optimization"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p class="text-xs text-white/50 mt-0.5">Auto-scale your winners</p>
                    </div>
                  </NuxtLink>
                  <NuxtLink
                    to="/ai-ads"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p class="text-xs text-white/50 mt-0.5">Intelligent recommendations</p>
                    </div>
                  </NuxtLink>
                </div>
              </div>
        ...
        <div v-if="mobileOpen" class="fixed inset-0 z-40 md:hidden">
          ...
          <div class="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-ink-900 shadow-xl overflow-y-auto flex flex-col">
            <div class="flex items-center justify-between border-b border-white/10 px-6 py-5 flex-shrink-0">
              ...
              <button class="text-white/60 hover:text-white transition-colors" @click="mobileOpen = false">
            ...
            <nav class="p-5 flex-1 space-y-1">
              <p class="text-xs uppercase tracking-widest text-white/30 px-2 mb-3">Workflows</p>
        ...
        <div class="mx-auto max-w-7xl px-6 pt-16 pb-10">
          <div class="grid grid-cols-2 gap-10 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1fr]">
            ...
            <div class="col-span-2 lg:col-span-1">
              ...
              <p class="mt-4 text-sm text-white/50 leading-relaxed max-w-52">
              ...
              <div class="mt-5 flex gap-3">
                <a href="#" class="h-8 w-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors" aria-label="Twitter">
                  <svg class="w-4 h-4 text-white/60" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.259 5.63 5.905-5.63z"/></svg>
                </a>
                ...
                <a href="#" class="h-8 w-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors" aria-label="YouTube">
                  <svg class="w-4 h-4 text-white/60" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
              </div>
            </div>
            ...
            <!-- Product -->
            <div>
              <p class="text-xs font-semibold uppercase tracking-widest text-white/35 mb-5">Product</p>
              <ul class="space-y-3.5 text-sm">
                <li><NuxtLink to="/analytics" class="text-white/55 hover:text-white transition-colors">Analytics</NuxtLink></li>
                <li><NuxtLink to="/optimization" class="text-white/55 hover:text-white transition-colors">Optimization</NuxtLink></li>
                <li><NuxtLink to="/ai-ads" class="text-white/55 hover:text-white transition-colors">AI Ads</NuxtLink></li>
                <li><NuxtLink to="/pricing" class="text-white/55 hover:text-white transition-colors">Pricing</NuxtLink></li>
                <li><NuxtLink to="/app" class="text-white/55 hover:text-white transition-colors">Dashboard</NuxtLink></li>
              </ul>
            </div>

            <!-- Company -->
            <div>
              <p class="text-xs font-semibold uppercase tracking-widest text-white/35 mb-5">Company</p>
              <ul class="space-y-3.5 text-sm">
                <li><NuxtLink to="/about" class="text-white/55 hover:text-white transition-colors">About Us</NuxtLink></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Blog</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Careers</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Partners</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Press</a></li>
              </ul>
            </div>

            <!-- Resources -->
            <div>
              <p class="text-xs font-semibold uppercase tracking-widest text-white/35 mb-5">Resources</p>
              <ul class="space-y-3.5 text-sm">
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Documentation</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Case Studies</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">API Reference</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Changelog</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Status</a></li>
              </ul>
            </div>

            <!-- Legal -->
            <div>
              <p class="text-xs font-semibold uppercase tracking-widest text-white/35 mb-5">Legal</p>
              <ul class="space-y-3.5 text-sm">
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Privacy Policy</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Terms of Service</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Cookie Policy</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">Security</a></li>
                <li><a href="#" class="text-white/55 hover:text-white transition-colors">GDPR</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="mt-14 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-8">
            <p class="text-xs text-white/35">© 2026 MetaFlow Technologies, Inc. All rights reserved.</p>
            <div class="flex flex-wrap items-center gap-5 text-xs text-white/35">
